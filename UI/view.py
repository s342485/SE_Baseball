...
class View:
    ...
    def load_interface(self):
        ...
        # Riga 1
        self.dd_anno = ft.Dropdown(label="Anno", width=200, alignment=ft.alignment.top_left, options=self.controller.get_years(), on_change=self.controller.get_team_by_year)
